...
class Settings(BaseModel):
    ...
    TRIAGE_MODEL: str = os.getenv("TRIAGE_MODEL", "llama3.2:1b")
    FAST_LLM_MODEL: str = os.getenv("FAST_LLM_MODEL", "llama3.2:1b")
    PRIMARY_LLM_MODEL: str = os.getenv("PRIMARY_LLM_MODEL", "llama3.2:1b")
    FULL_LLM_MODEL: str = os.getenv("FULL_LLM_MODEL", "qwen3.5:4b")
    FALLBACK_LLM_MODEL: str = os.getenv("FALLBACK_LLM_MODEL", "qwen3.5:4b")
